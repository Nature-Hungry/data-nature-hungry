    ...
    <div className="mx-auto max-w-6xl px-4 py-10">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2">
          ...
          <h1 className="mb-3 font-heading text-2xl font-bold text-primary">{dataset.title}</h1>
        ...
        <aside className="h-fit rounded-lg border border-line border-t-4 border-t-rose bg-white p-5">
